...
// Статические файлы (ВАЖНО: абсолютный путь)
...
// 7. Действия админа (бан/мут/админ)
...
app.get('/api/messages', async (req, res) => {
  try {
    ...
    res.json({
      success: true,
      messages: messages.reverse() // Старые сверху
    });
...
server.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`🌐 URL: https://acarius-chat.onrender.com`);
